    ...
    return (
      <div className="fixed inset-0 bg-black flex items-center justify-center z-[9999]">
        <div className="text-center text-white animate-fade-in flex flex-col items-center justify-center">
          ...
          <p className="text-2xl font-semibold ml-8 sm:ml-16 translate-x-4 sm:translate-x-6 transition-transform">goodbye</p>
        </div>
      </div>
    );
  }
        ...
        <div className="relative">
          <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2">
            <button
              ...
              className="p-1 rounded-md bg-gray-500 text-gray-200 hover:bg-gray-700 hover:animate-bounce transition shadow font-mono text-sm"
